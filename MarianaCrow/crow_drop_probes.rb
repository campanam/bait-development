begin
    ...
    File.open("Ckubaryi_probes-relaxed-2-concat.txt", 'r') do |getcontigs|
    ...
    File.open("Ckubaryi_probes-relaxed2-selected.txt", 'w') do |outselect|
        outselect.puts outline
    end
    outfasta = ""
    writeseq = false
    File.open("Ckubaryi_probes_concat.fas" , 'r') do |getprobes|
    ...
    File.open("Ckubaryi_probes-relaxed2-selected.fas", 'w') do |out|
        out.puts outfasta
    end
end